...
class People(models.Model):
    ...
    url_token = models.CharField(verbose_name="token", max_length=50, null=True)
    url = models.CharField(verbose_name="用户api", max_length=256, null=True)
    avatar_url_template = models.CharField(verbose_name="头像url模板", max_length=128, null=True)
    ...
    followed_count = models.IntegerField(verbose_name="关注数", null=True)
    follower_count = models.IntegerField(verbose_name="关注者数", null=True)
    approval_num = models.IntegerField(verbose_name="赞同数", null=True)
    thanks_num = models.IntegerField(verbose_name="感谢数", null=True)
    collected_num = models.IntegerField(verbose_name="收藏数", null=True)
    follow_live_num = models.IntegerField(verbose_name="赞助live数", null=True)
    follow_topic_num = models.IntegerField(verbose_name="关注话题数", null=True)
...
class Follow(models.Model):
    follower = models.ForeignKey(People, related_name="follower")
    followed = models.ForeignKey(People, related_name="followed")
